...
public abstract class BaseDatasourceService implements IDBDatasourceService {
		...
		/**
		 * This should have been abstract, but changes to this API at a point release is
		 * not advised.
		 * 
		 * @param name
		...
		/**
		 * Since JNDI is supported different ways in different app servers, it's nearly
		 * impossible to have a ubiquitous way to look up a datasource. This method is
		 * intended to hide all the lookups that may be required to find a jndi name,
		 * and return the actual bound name.
		 * 
		 * @param dsName
		 ...
		 * Since JNDI is supported different ways in different app servers, it's nearly
		 * impossible to have a ubiquitous way to look up a datasource. This method is
		 * intended to extract just the regular name of a specified JNDI source.
		 * 
		 * @param dsName
